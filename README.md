...
Motivated and detail-oriented individual with a strong foundation in Web Development, UI/UX Design, and Software Engineering. Skilled in creating responsive websites, designing user-friendly interfaces, and developing interactive digital solutions. Experienced in working with modern tools and technologies, and eager to contribute creativity, technical proficiency, and problem-solving skills to innovative projects.
...
**London Metropolitan University (UK)** | *2025-Present*

### Level 5 Pearson BTEC HND in Computing (Software Engineering)
**Pearson College, London** | *2024-2025*

### Level 03 Diploma in Information Technology (UK Certification)
**Esoft Metro Campus, Sri Lanka** | *2024-Full year*

### General Certificate of Education Ordinary Level & Advanced Level (Maths Stream)
**Mahinda College, Galle, Sri Lanka** | *2010-2023*
...
### 🎵 Apple Music Player UI/UX Design | Apr 2025 - May 2025
Designed a sleek, immersive UI/UX concept for an Apple Music player with dynamic backgrounds and real-time song data, focusing visual appeal and user experience.
- Created interactive prototypes in Figma
- Skills: Figma, UI/UX design, mobile-first approach, user-centered design
- [View Prototype](https://www.figma.com/)

### 💰 Apex Financial App | UI/UX Design | Sep 2025 - Present
Designed a modern financial management app with intuitive dashboards, clear data visualization, and user-friendly navigation to enhance money-tracking and budgeting.
- Built interactive prototypes in Figma
- Skills: Figma, UI/UX design, financial dashboard, data visualization, user flows, prototyping

### 🛍️ Velvet Vogue | Full-Stack E-commerce | Feb 2025 - Jun 2025
Developed "Velvet Vogue," a responsive PHP + MySQL e-commerce site with user auth, product catalog, shopping cart, and admin dashboard for inventory management.
- Built front-end components with HTML, CSS & JavaScript, managed version control on GitHub
- Skills: PHP, MySQL, HTML, CSS, JavaScript, Git, responsive web design
...
**Currently Studying:**
- BEng (Hons) in Software Engineering at London Metropolitan University
...
- Database design and management (MongoDB, MySQL, SQLite)
...
**Mobile:** +94 789 501 781  
**Location:** 227/1, Katuwalagodawatta, Beranagoda, Yakkalamulla, Galle, Sri Lanka
...
- [Facebook](https://facebook.com/sathsarajayantha01/)
